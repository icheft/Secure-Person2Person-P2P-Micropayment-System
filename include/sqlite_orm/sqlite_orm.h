...
namespace internal {
    ...
    template <typename D>
    SQLITE_ORM_INLINE_VAR constexpr bool is_stateless_deleter_v = std::is_empty<D>::value&& std::is_default_constructible<D>::value;
...
#ifdef __cpp_lib_concepts
    template <typename D>
    concept is_unusable_for_xdestroy = (!stateless_deleter<D> && (can_yield_fp<D> && !std::same_as<yielded_fn_t<D>, xdestroy_fn_t>));

    template <typename D>
    concept can_yield_xdestroy = can_yield_fp<D> && std::same_as<yielded_fn_t<D>, xdestroy_fn_t>;

    template <typename D, typename P>
    concept needs_xdestroy_proxy = (stateless_deleter<D> && (!can_yield_fp<D> || !std::same_as<yielded_fn_t<D>, xdestroy_fn_t>));
...
#else
    template <typename D>
    SQLITE_ORM_INLINE_VAR constexpr bool is_unusable_for_xdestroy_v = !is_stateless_deleter_v<D> && (can_yield_fp_v<D> && !std::is_same<yielded_fn_t<D>, xdestroy_fn_t>::value);

    template <typename D>
    SQLITE_ORM_INLINE_VAR constexpr bool can_yield_xdestroy_v = can_yield_fp_v<D>&& std::is_same<yielded_fn_t<D>, xdestroy_fn_t>::value;

    template <typename D, typename P>
    SQLITE_ORM_INLINE_VAR constexpr bool
        needs_xdestroy_proxy_v
...
namespace internal {
    ...
    struct table_type<F O::*,
        typename std::enable_if<std::is_member_pointer<F O::*>::value && !std::is_member_function_pointer<F O::*>::value>::type>
    {
        using type = O;
    };
...
namespace internal {
    ...
    struct unique_t : unique_base
    {
        ...
        unique_t(columns_tuple columns_)
            : columns(move(columns_)) { }
    };
    ...
    struct foreign_key_t<std::tuple<Cs...>, std::tuple<Rs...>>
    {
        ...
        foreign_key_t(columns_type columns_, references_type references_)
            : columns(move(columns_)), references(move(references_)), on_update(*this, true, foreign_key_action::none), on_delete(*this, false, foreign_key_action::none) { }

        foreign_key_t(const self& other)
            : columns(other.columns), references(other.references), on_update(*this, true, other.on_update._action), on_delete(*this, false, other.on_delete._action) { }
    ...
    struct collate_constraint_t
    {
        ...
        collate_constraint_t(internal::collate_argument argument_)
            : argument(argument_) { }
    ...
    struct check_t : check_string
    {
        ...
        check_t(expression_type expression_)
...
namespace internal {
    ...
    struct is_primary_key_insertable
    {
        ...
        static constexpr bool value = (tuple_helper::tuple_contains_some_type<default_t, constraints_type>::value || tuple_helper::tuple_contains_type<autoincrement_t, constraints_type>::value || std::is_base_of<integer_printer, type_printer<field_type>>::value);
    };
}
...
namespace internal {
    ...
    struct serializator_context : serializator_context_base
    {
        ...
        serializator_context(const impl_type& impl_)
            : impl(impl_) { }
...
namespace internal {
    ...
    struct bitwise_not_t : bitwise_not_string, arithmetic_t, negatable_t
    {
        ...
        bitwise_not_t(argument_type argument_)
...
namespace internal {
    ...
    struct is_field_member_pointer<T,
        typename std::enable_if<std::is_member_pointer<T>::value && !std::is_member_function_pointer<T>::value>::type>
        : std::true_type
    { };
}
}
...
namespace internal {
    ...
    struct column_t : basic_column
    {
        ...
        column_t(std::string name_,
            ...
            : basic_column { move(name_) }, member_pointer(member_pointer_), getter(getter_), setter(setter_), constraints(move(constraints_)) { }
...
namespace internal {
    ...
    struct collate_t : public condition_t
    {
        ...
        collate_t(T expr_, collate_argument argument_)
    ...
    struct order_by_t : order_by_base, order_by_string
    {
        ...
        order_by_t(expression_type expression_)
            : order_by_base(), expression(std::move(expression_)) { }
        ...
        {
            auto res = *this;
            res._collate_argument = collate_constraint_t::string_from_collate_argument(sqlite_orm::internal::collate_argument::binary);
            return res;
        }
        ...
        {
            auto res = *this;
            res._collate_argument = collate_constraint_t::string_from_collate_argument(sqlite_orm::internal::collate_argument::nocase);
            return res;
        }
        ...
        {
            auto res = *this;
            res._collate_argument = collate_constraint_t::string_from_collate_argument(sqlite_orm::internal::collate_argument::rtrim);
            return res;
        }
    ...
    struct multi_order_by_t : order_by_string
    {
        ...
        multi_order_by_t(args_type&& args_)
            : args(std::move(args_)) { }
    };
    ...
    struct dynamic_order_by_t : order_by_string
    {
        ...
        dynamic_order_by_t(const context_t& context_)
            : context(context_) { }
    ...
    struct left_join_t : left_join_string
    {
        ...
        left_join_t(on_type constraint_)
    ...
    struct left_outer_join_t : left_outer_join_string
    {
        ...
        left_outer_join_t(on_type constraint_)
            : constraint(std::move(constraint_)) { }
    };
    ...
    struct inner_join_t : inner_join_string
    {
        ...
        inner_join_t(on_type constraint_)
            : constraint(std::move(constraint_)) { }
    };
    ...
    struct cast_t : cast_string
    {
        ...
        cast_t(expression_type expression_)
            : expression(std::move(expression_)) { }
    };
...
template <class L,
    class R,
    typename = typename std::enable_if<std::is_base_of<internal::condition_t, L>::value || std::is_base_of<internal::condition_t, R>::value>::type>
...
namespace internal {
    ...
    struct built_in_function_t : S, arithmetic_t
    {
        ...
        built_in_function_t(args_type&& args_)
            : args(std::move(args_)) { }
    };
...
namespace internal {
    ...
    struct where_t : where_string
    {
        ...
        where_t(expression_type expression_)
            : expression(std::move(expression_)) { }
    };
...
namespace internal {
    ...
    struct set_t : set_string
    {
        ...
        set_t(assigns_type assigns_)
            : assigns(move(assigns_)) { }
    };
    ...
    struct simple_case_builder
    {
        ...
        simple_case_builder<R, T, E, Args..., std::pair<W, Th>> when(W w, then_t<Th> t)
        {
            ...
            result_args_type result_args = std::tuple_cat(std::move(this->args), std::move(std::make_tuple(newPair)));
...
internal::set_t<Args...> set(Args... args)
{
    ...
    static_assert(std::tuple_size<arg_tuple>::value == internal::count_tuple<arg_tuple, internal::is_assign_t>::value,
...
struct table_info
{
    ...
    table_info(decltype(cid) cid_,
        ...
        decltype(pk) pk_)
        : cid(cid_), name(move(name_)), type(move(type_)), notnull(notnull_), dflt_value(move(dflt_value_)), pk(pk_) { }
};
 ...
 */
using statement_finalizer = std::unique_ptr<sqlite3_stmt, std::integral_constant<decltype(&sqlite3_finalize), sqlite3_finalize>>;
}
#pragma once
#include <type_traits>
...
protected:
    ...
    pointer_binding(P* p, D d = {}) noexcept
        : p_ { p }, d_ { std::move(d) } { }
...
namespace internal {
    ...
    struct function_base
    {
        ...
        function_base(decltype(name) name_,
            ...
            : name(move(name_)), argumentsCount(argumentsCount_), create(move(create_)), destroy(destroy_) { }
    };
    ...
    struct scalar_function_t : function_base
    {
        ...
        scalar_function_t(decltype(name) name_,
            ...
            decltype(run) run_,
            decltype(destroy) destroy_)
            : function_base { move(name_), argumentsCount_, move(create_), destroy_ }, run(move(run_)) { }
    };
    ...
    struct aggregate_function_t : function_base
    {
        ...
        aggregate_function_t(decltype(name) name_,
            ...
            decltype(destroy) destroy_)
            : function_base { move(name_), argumentsCount_, move(create_), destroy_ }, step(move(step_)), finalCall(move(finalCall_)) { }
    };
    ...
    SQLITE_ORM_INLINE_VAR constexpr bool
        is_same_pvt_v<I, PointerArg, Binding, polyfill::void_t<typename PointerArg::tag, typename Binding::tag>> = assert_same_pointer_type<I, PointerArg::tag::value, Binding::tag::value>();
#else
    template <size_t I, class PointerArg, class Binding>
    SQLITE_ORM_CONSTEVAL bool assert_same_pointer_type()
    {
    ...
    template <size_t I, class PointerArg, class Binding>
    SQLITE_ORM_INLINE_VAR constexpr bool
        is_same_pvt_v<I, PointerArg, Binding, polyfill::void_t<typename PointerArg::tag, typename Binding::tag>> = assert_same_pointer_type<I, typename PointerArg::tag, typename Binding::tag>();
#endif
    ...
    SQLITE_ORM_CONSTEVAL bool validate_pointer_value_types(polyfill::index_constant<I>)
    {
        ...
        constexpr bool valid = validate_pointer_value_type<I,
            ...
            polyfill::bool_constant < (polyfill::is_specialization_of_v<func_arg_t, pointer_arg>) || (polyfill::is_specialization_of_v<passed_arg_t, pointer_binding>) > {});
...
internal::function_call<F, Args...> func(Args... args)
{
    ...
    static_assert((argsCount == functionArgsCount && !std::is_same<function_args_tuple, std::tuple<arg_values>>::value && internal::validate_pointer_value_types<function_args_tuple, args_tuple>(internal::polyfill::index_constant<std::min<>(functionArgsCount, argsCount) - 1> {})) || std::is_same<function_args_tuple, std::tuple<arg_values>>::value,
...
namespace internal {
    ...
    struct table_t : basic_table
    {
        ...
        table_t(std::string name_, elements_type elements_)
            : super { move(name_) }, elements { move(elements_) } { }
            ...
            std::vector<table_info>& dbTableInfo)
        {
            ...
            for (size_t storageColumnInfoIndex = 0; storageColumnInfoIndex < storageTableInfo.size();
                ...
                if (dbColumnInfoIt != dbTableInfo.end()) {
                    ...
                    auto columnsAreEqual = dbColumnInfo.name == storageColumnInfo.name && dbColumnInfo.notnull == storageColumnInfo.notnull && (dbColumnInfo.dflt_value.length() > 0) == (storageColumnInfo.dflt_value.length() > 0) && dbColumnInfo.pk == storageColumnInfo.pk;
                    if (!columnsAreEqual) {
                        notEqual = true;
                        break;
                    }
...
namespace internal {
    ...
    struct mapped_row_extractor
    {
        ...
        mapped_row_extractor(const table_info_t& tableInfo_)
...
namespace internal {
    ...
    struct prepared_statement_t : prepared_statement_base
    {
        ...
        prepared_statement_t(prepared_statement_t&& prepared_stmt)
            : prepared_statement_base { prepared_stmt.stmt, std::move(prepared_stmt.con) }, expression(std::move(prepared_stmt.expression))
        {
...
internal::insert_raw_t<Args...> insert(Args... args)
{
    ...
    static_assert(argsCount == intoArgsCount + columnsArgsCount + valuesArgsCount + defaultValuesCount + selectsArgsCount + orArgsCount + upsertClausesCount,
...
internal::replace_raw_t<Args...> replace(Args... args)
{
    ...
    constexpr int argsCount = int(std::tuple_size<args_tuple>::value);
    static_assert(argsCount == intoArgsCount + columnsArgsCount + valuesArgsCount + defaultValuesCount + selectsArgsCount,
...
namespace internal {
    ...
    struct pragma_t
    {
        ...
        pragma_t(get_connection_t get_connection_)
            : get_connection(move(get_connection_)) { }
...
namespace internal {
    ...
    struct backup_t
    {
        backup_t(connection_ref to_,
            ...
            : handle(sqlite3_backup_init(to_.get(), zDestName.c_str(), from_.get(), zSourceName.c_str())), holder(move(holder_)), to(to_), from(from_)
        {
            if (!this->handle) {
...
struct arg_value
{
    ...
    arg_value(sqlite3_value* value_)
        : value(value_) { }
...
struct arg_values
{
    ...
    struct iterator
    {
        ...
        iterator(const arg_values& container_, int index_)
            : container(container_), index(index_), currentValue(index_ < int(container_.size()) ? container_[index_] : arg_value()) { }
    ...
    arg_values()
        : arg_values(0, nullptr) { }

    arg_values(int argsCount_, sqlite3_value** values_)
        : argsCount(argsCount_), values(values_) { }
...
namespace internal {
    ...
    protected:
        storage_base(const std::string& filename_, int foreignKeysCount)
            : pragma(std::bind(&storage_base::get_connection, this)), limit(std::bind(&storage_base::get_connection, this)), inMemory(filename_.empty() || filename_ == ":memory:"), connection(std::make_unique<connection_holder>(filename_)), cachedForeignKeysCount(foreignKeysCount)
        {
            if (this->inMemory) {
                this->connection->retain();
                this->on_open_internal(this->connection->get());
        ...
        storage_base(const storage_base& other)
            : on_open(other.on_open), pragma(std::bind(&storage_base::get_connection, this)), limit(std::bind(&storage_base::get_connection, this)), inMemory(other.inMemory), connection(std::make_unique<connection_holder>(other.connection->filename)), cachedForeignKeysCount(other.cachedForeignKeysCount)
        {
            if (this->inMemory) {
                this->connection->retain();
                this->on_open_internal(this->connection->get());
        ...
        void on_open_internal(sqlite3* db)
        {
            ...
            for (auto& p : this->collatingFunctions) {
                auto resultCode = sqlite3_create_collation(db, p.first.c_str(), SQLITE_UTF8, &p.second, collate_callback);
                if (resultCode != SQLITE_OK) {
                    throw std::system_error(std::error_code(sqlite3_errcode(db), get_sqlite_error_category()),
                        sqlite3_errmsg(db));
                }
...
namespace internal {
    ...
    struct table_name_collector
    {
        ...
        table_name_collector(find_table_name_t _find_table_name)
            : find_table_name(std::move(_find_table_name)) { }
    ...
    struct statement_serializator<insert_t<T>, void>
    {
        ...
        std::string operator()(const statement_type& statement, const C& context) const
        {
            ...
            tImpl.table.for_each_column([&tImpl, &columnIndex, &ss](auto& column) {
                using table_type = typename std::decay<decltype(tImpl.table)>::type;
                if (table_type::is_without_rowid || (!column.template has<primary_key_t<>>() && !tImpl.table.exists_in_composite_primary_key(column))) {
                    if (0 == columnIndex) {
                        ss << '(';
                    } else {
                        ss << ", ";
...
namespace internal {
    ...
    struct storage_t : storage_base
    {
        ...
        storage_t(const storage_t& other)
            : storage_base(other), impl(other.impl) { }
            ...
            bool preserve)
        {
            ...
            if (schema_stat != decltype(schema_stat)::already_in_sync) {
                if (schema_stat == decltype(schema_stat)::new_table_created) {
                    ...
                    if (schema_stat == sync_schema_result::old_columns_removed || schema_stat == sync_schema_result::new_columns_added || schema_stat == sync_schema_result::new_columns_added_and_old_columns_removed) {
        ...
        void execute(const prepared_statement_t<T>& statement)
        {
            ...
            auto processObject = [&index, &stmt, &tImpl, db](auto& object) {
                tImpl.table.for_each_column([&index, stmt, &object, db](auto& column) {
                    ...
                    using field_type = typename column_type::field_type;
                    if (column.member_pointer) {
                        if (SQLITE_OK != statement_binder<field_type>().bind(stmt, index++, object.*column.member_pointer)) {
